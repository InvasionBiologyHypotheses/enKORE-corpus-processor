  ...
  function remove_bad_char1(input) {
    ...
    for (var i=0; i<input.length; i++) {
        ...
        if (input.charCodeAt(i) <= 127) {
          ...
          const char_p1 = ' “ ” ≤ ≥ « » ¹ ³ ⁻ — → ∙ ≈ ≠ ≃ … ∞ ° ‰ ф Ф Φ ẞ ß β λ Δ ∆ ð δ ψ μ  € Є £ ℃ ';
          const char_p2 = ' ♀ ♂ ♀ ™ ® © Ⅳ § ¥ ¡ ¤ ';  
          const char_p3 = ' ь в ć Č č Ç ç ¢ Đ Ð ǧ ğ н ī κ ļ ľ ń ņ Ñ ñ ň Þ þ ř л ś Ś Ș ș Ş ş Š š  ł Ł ț ý Ý Ÿ ÿ ż Ž ž Ż ';
          const char_A = ' Æ æ  Á á Â â À à Å å Ã ã Ä ä ą ā ă '; 
          const char_E = ' É é Ê ê É È Ê Ë ë ė Ė è ę Ę ē ě '; 
          const char_I = ' Í í Î î Ì ì Ï ï İ '; 
          const char_O = ' Ó ó Ô ô Ò ò Ø ø Õ õ Ö ö ő '; 
          const char_U = ' Ú ú Û û Ù ù Ü ü ů Ū ū ';  
