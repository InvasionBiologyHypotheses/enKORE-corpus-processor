...
import { function_log } from "./log.js";
// #########################################
...
export function generateXML({ wikidataItem, crossrefItem, accumulatedData }) {
  ...
  function remove_bad_char1(input) {
    ...
    if (list_char_deleted != "") {
      ...
      function_log('./logs/','Log_invalid_characters.txt',filename_this + `XML-file: ${`${wikidataItem_id_string.replaceAll("\"", "")}.xml`}`);
      function_log('./logs/','Log_invalid_characters.txt',filename_this + `list of deleted char: ${list_char_deleted}`);
