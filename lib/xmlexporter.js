  ...
  function remove_bad_char1(input) {
    ...
    for (var i=0; i<input.length; i++) {
        ...
        if (input.charCodeAt(i) <= 127) {
          ...
          //const valid_UTC8 = 'ф';
          const char_p0 = '× ’ ‘ – γ ∼ α ı С о ‐ “ ” ∞ ° … ‰ Φ μ µ β ψ μ λ Δ δ € → ≠ ≃'; 
          const char_p1 = 'ф ẞ ß Ð ð Ç ç ¢ Ñ ñ Ý ý Ÿ ÿ ® © Þ þ § ¥ £ ¡ ¤'; 
          const char_p2 = 'ă Á á Â â À à Å å Ã ã Ä ä Æ æ ą ā'; 
          const char_p3 = 'É é Ê ê Ç É È Ê Ë ë ė Ė è ę Ę ē ě'; 
          const char_p4 = 'Í í Î î Ì ì Ï ï'; 
          const char_p5 = 'Ó ó Ô ô Ò ò Ø ø Õ õ Ö ö ő'; 
          const char_p6 = 'Ú ú Û û Ù ù Ü ü ů ū Ū'; 
          const char_p7 = 'Í İ í Î î Ì ì Ï ï İ';  
          const char_p8 = 'č ć Č Đ ǧ ğ ī ļ ľ ń ņ ř ś ş Ş š Š ł Ł ż ž Ž Ż ≤ ≥ ¹ ³ ⁻ — ';
          const char_p9 = '♀ ♂ ♀ Ⅳ';           
          
          const valid_UTC8 = char_p0 + char_p1 + char_p2 + char_p3 + char_p4 + char_p5 + char_p6 + char_p7 + char_p8 + char_p9;
