  ...
  function remove_bad_char1(input) {
    ...
    for (var i=0; i<input.length; i++) {
        ...
        if (input.charCodeAt(i) <= 127) {
          ...
          //const valid_UTC8 = 'ф';
          const char_p0 = '× ’ ‘ – γ ∼ α ı С о ‐'; 
          const char_p1 = '“ ” ≤ ≥ ¹ ³ ⁻ — → ≠ ≃ … ∞ ° ‰ ф Φ ẞ ß β λ Δ ð δ ψ μ € £';
          const char_p2 = '♀ ♂ ♀ ® © Ⅳ § ¥ ¡ ¤';  
          const char_p3 = 'č ć Č Ç ç ¢ Đ Ð ǧ ğ ī ļ ľ ń ņ Ñ ñ Þ þ ř ś Ş ş Š š ł Ł ý Ý Ÿ ÿ ż Ž ž Ż';
          const char_A = 'Æ æ Á á Â â À à Å å Ã ã Ä ä ą ā ă'; 
          const char_E = 'É é Ê ê Ç É È Ê Ë ë ė Ė è ę Ę ē ě'; 
