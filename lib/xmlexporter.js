  ...
  function remove_bad_char1(input) {
    ...
    for (var i=0; i<input.length; i++) {
        ...
        if (input.charCodeAt(i) <= 127) {
          ...
          // ##### Note: do not append non-ASCII, but we can check exceptions to append if UTF-8 valid!
          // ##### Note: Insert all non-ASCII characters which are valid UTF-8.
          const valid_UTC8 = "ф"; // ##### "ф ’ "
          if (valid_UTC8.includes(input.charAt(i))) {
