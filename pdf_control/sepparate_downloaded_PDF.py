...
output_file_path1 = "PDF_not_obtained.txt"  # Replace with the desired output file path
output_file_path2 = "PDF_obtained.txt"  # Replace with the desired output file path
    ...
    with open(file_read, "r") as file:
        ...
        for line in file:
            ...
            with open(output_file_path1, "r") as file_path1:
                ...
                if line_reduced not in data1 and "## NOT" in line:

                    # line = line.replace(" ## NOT", "");

                    with open(output_file_path1, "a") as output_file_temp:

                        output_file_temp.write(line_reduced);
